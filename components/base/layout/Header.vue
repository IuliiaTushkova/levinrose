    ...
    <header class="w-full text-gray-700 bg-white border-t border-gray-100 shadow-sm body-font">
        <div class="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
            ...
            <nav class="flex flex-wrap items-center text-base lg:w-2/5 md:ml-auto">
                <NuxtLink to="/auth" class="mr-5 font-medium hover:text-gray-900">Ma page</NuxtLink>
                <NuxtLink to="/about" class="mr-5 font-medium hover:text-gray-900">Qui sommes-nous ?</NuxtLink>
                <NuxtLink to="/contactUs" class="mr-5 font-medium hover:text-gray-900">Nous contacter</NuxtLink>
            </nav>
            <a
            ...
            <div class="inline-flex items-center h-full ml-5 lg:w-2/5 lg:justify-end lg:ml-0">
                <NuxtLink to="/auth" class="mr-5 font-medium hover:text-gray-900">Se connecter</NuxtLink>
                <NuxtLink to="/signup" class="px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-teal-500 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease">Créer un compte</NuxtLink>
            </div>
        </div>
    </header>
</template>